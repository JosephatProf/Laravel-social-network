    ...
    <div class="col-sm-3">
      ...
      <p><span style="color: blue;">Choose any to chat with, Enjoy.</span></p>
            ...
            @else
                ...
                <div class="media">
                    <a class="pull-left" href="{{ route('message.reply', ['messageId'=>$user->id]) }}">
                        <img class="img-circle" alt="{{ $user->getNameOrUsername() }}" src="{{ asset('images/profile'.'/'.$user->profile_image) }}" height="40px" width="40px">
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading"><a href="{{ route('message.reply', ['messageId'=>$user->id]) }}">{{ $user->getNameOrUsername() }}</a></h4>
        ...
        <div class="col-sm-7">
            <div class="panel panel-success" id="chatpanel">
                ...
                @foreach ($data as $text)
                    <ul class="chat">
                        ...
                        <li class="left clearfix"><span class="chat-img pull-left">
                            ...
                            <div >
                                <img alt="{{ Auth::user()->getNameOrUsername() }}" src="{{ asset('images/profile'.'/'.Auth::user()->getProfileImage()) }}" 
                        class="media-object" style="width: 40px; height: 40px;">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font">{{ Auth::user()->getNameOrUsername() }}</strong> <small class="pull-right text-muted">
                                        <span class="glyphicon glyphicon-time"></span>2 secs ago</small>
                                </div>
                                <!-- $messo->created_at->diffForHumans() later for modifications -->
                                <p >{{ $text->message }}</p>
                            </div>
                        </li>
                        ...
                        class="media-object" style="width: 40px; height: 40px;">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font">{{ $text->friend_id }}</strong> <small class="pull-right text-muted">
                ...
                <div class="panel-footer">
                    ...
                    <form role="form" method="post" action="{{ route('messages.post',['friendId'=>$text->friend_id]) }}">
